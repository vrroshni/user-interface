...
const Header = () => {
    return (
        <div className="w-full h-[7rem] flex flex-row justify-between relative">
            <div>
                ...
                <div className=" absolute top-5 left-6">
                    <img src="https://www.pivotical.social/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.58ca0829.png&w=384&q=100" alt="" srcset="" className="h-20" />
                </div>
            </div>

            <div className="flex gap-4 items-center justify-center px-7 absolute top-8 right-14">
