...
const RightBar = () => {
    return (
        <div className='  flex flex-col justify-between h-1/3  lg:h-full' >
            <div className=" w-13 h-16 bg-white rounded-l-lg shadow-md px-2 py-2">
                <div className='relative'>
                    <BsFillBellFill className={"text-blue-400 w-10 h-10    "} />
                    <div className="absolute top-0 -right-0 h-4 w-4   rounded-full bg-red-600 z-2 text-white flex justify-center items-center items">4</div>
                </div>
            </div>
